...
const Navbar = () => {
  const { cart, login, setLogin, setShowModal, setCart, setCurrUser } =
        ...
        <div class="relative w-full flex h-16 items-center justify-between">
          <div className="flex">
            <img
              ...
              alt="img"
            />
            <h2 className="m-2 text-white cursor-pointer">Restaurant</h2>
          </div>
          {login ? (
            <div class="flex gap-2 items-center justify-center sm:items-stretch sm:justify-start">
              <div className="font-sans mt-2 self-center block lg:inline-block text-black hover:text-gray-700">
                <button
